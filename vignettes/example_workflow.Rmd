...
### 2.8 find all cells per cell type that express the full set of nodes in gene.list
```{r}
...
Gria2_markers = markerNodes(object = idx_above, gene.list = Gria2_nodes$Node_id, log.message = FALSE)
head(Gria2_markers)
```
...
```{r}
# another function to find cell type specific nodex, for specific node types in certain gene
